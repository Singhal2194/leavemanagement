...
<div id="signin-page-content">
    ...
    <form action="hod_login.php" class="form" method="post"><h3 class="block-heading" align="center">Sign In</h3>

        <p>Enter Username and passward</p>
        ...
        <hr>
		 <div class="form-group" align="center">
            <a href="../firstpg.html" class="btn-lg btn-green">Home</a>
           </div>
...
if(isset($_POST["username"])&&isset($_POST["password"]))
{
	...
	if(!empty($username)&&!empty($password))
	{
		...
		if($query_run=mysql_query($query))
		{
			...
			if($query_data["password"]==$password && $username=="HoD")
			{
				$welcome='hod_home.php';
