    ...
    <div >
        ...
        <div id="wrapper">
             ...
             <nav id="sidebar" role="navigation" class="navbar-default navbar-static-side">
                <div class="sidebar-collapse menu-scroll">
					...
					<h4><font color="white" align="center"> Dept Of Information Science</font></h4>
						...
						<li><a href="view_co_dates.php">CO Dates</a></li>
            ...
            <div id="page-wrapper">
				...
				<form  method="post" action="view_co_dates.php">
				...
				<div>
				 <input id="saveForm" class="btn btn-orange btn-lg" type="submit" name="submit" value="Submit" />
				</div>
				</div>
				</div>
				</div>
...
if(!empty($_POST["username"])) 
{
	echo "here";
		...
		$username=$_POST["username"];
			...
			$query="SELECT * FROM co_dates WHERE staff_id='$username'";
			...
			if($results)
				...
				for($i=0;$i<$rows;$i++)
            	{	
					$staffid=mysql_result($result,$i,'staff_id');
					$fname=mysql_result($result,$i,'dates');
				}

		echo '<div class="page-content">';
		echo'		<div class="panel panel-yellow">';
         echo'<div class="panel-heading" align="middle"><h2>Staff Leave Report</h2></div>';
	 	echo'<div class="portlet" style="color:black;">';
             echo'               <div class="portlet-header">';
                           
                  echo'              <div class="tools"><i class="fa fa-chevron-up"></i><i data-toggle="modal"
                            ...
                            echo'    <div class="table-responsive">';
                               echo'     <table class="table table-striped table-bordered table-hover">';
                                  echo'      <thead>';
									...
									echo'		<th>Dates</th>	';
									echo'</tr>';	
								echo "<tr><td>" .$staffid. "</td><td>" . $dates ."< /td></tr>";
