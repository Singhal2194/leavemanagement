...
<div id="signin-page-content">
 ...
 <h3 class="block-heading" align="center">Sign In</h3>

          <form action="staff_login.php" class="form" method="post">
        ...
        <div class="form-group" align="center">
            <button type="submit" class="btn-lg btn-green">Login
                &nbsp;<i class="fa fa-chevron-circle-right"></i></button>
           </div>
        <hr>
        <div class="form-group" align="center">
            <a href="../firstpg.html" class="btn-lg btn-blue">Home</a>
           </div>
    </form>
</div>
