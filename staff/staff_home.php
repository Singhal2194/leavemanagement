        ...
        <div id="wrapper">
            ...
            <nav id="topbar" role="navigation" style="margin-bottom: 0;" class="navbar navbar-default navbar-static-top">
                <div class="navbar-header">
                    ...
                    <a id="logo" href="admin_home.php" class="navbar-brand" style="font-size:18px">Leave Management System</a></div>
            ...
            <nav id="sidebar" role="navigation" class="navbar-default navbar-static-side">
                <div class="sidebar-collapse menu-scroll">
                    <ul id="side-menu" class="nav">
                       <div align="center"><img src="rvce.jpg" align="middle"  width="140" height="140" class="img-responsive img-circle" alt="Leave Management System" /></div>
					...
					<li>
						<a href="staff_assign.php#page-top">Assign Class</a>
					</li>
					  <li>
                        ...
                        <div class="panel">
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
									<h2 class="animated rotateIn" align="middle"> <font color="black">Welcome <?php
			...
			$result=mysql_query($query);
			$row=mysql_fetch_assoc($result);
			echo  $row["title"] . " " . $row["f_name"] . " " . $row["l_name"] ;?></font>  </h2>
									<br><br>
...
<?php
	...
	*/
    ...
    $result = mysql_query("SELECT * FROM leave_app WHERE staff_id='$uname'");
    ...
    while($db_field = mysql_fetch_assoc($result)) {
        echo "{";
        echo "title: '" . $db_field['type'] ."-". $db_field['status'] ."',";
